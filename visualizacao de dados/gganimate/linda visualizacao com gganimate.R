...
setwd("C:/Users/steve/OneDrive/Documents/GitHub/Ferramentas_do_RMarkdown/visualizacao de dados/gganimate/")

#download relevant files from https://www.gapminder.org/data/, and save to /data folder
